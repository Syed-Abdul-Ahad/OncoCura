    ...
    return (
        <div className="bg-gray-200 min-h-screen flex flex-col items-center">
            <div className="absolute left-1/2 transform -translate-x-1/2 top-12 sm:top-16 lg:top-20 xl:top-24 flex items-center p-3 sm:p-4 lg:p-5">
                ...
                <img src={'/tool.png'} alt="Tool Icon" className="ml-2 w-5 h-5 sm:w-7 sm:h-7 lg:w-9 lg:h-9 xl:w-10 xl:h-10" />
            </div>
            <div className="bg-white font-poppins rounded-3xl shadow-xl border-gray-200 w-full max-w-lg sm:max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-5xl mx-auto p-8 text-left relative fixed sm:-bottom-52 md:-bottom-60 lg:-bottom-72 left-5">
                <div className="border-b border-gray-300 mb-5">
                    <h2 className="text-xl font-bold text-black mt-0 mb-2">Personalized AI-Driven Treatment Plan</h2>
                    <p className="text-sm text-gray-600 mb-4">A tailored Medical Solution By AI to Help you with your treatment.</p>
                </div>
    ...
    <div className="text-gray-600 text-base text-justify">
        {analysisResult.split('\n').map((line, index) => {
            ...
            if (line.startsWith('•')) {
                ...
                const boldRegex = /\*\*(.*?)\*\*/g;
                const formattedLine = line.replace(boldRegex, '<strong>$1</strong>'); // Replace with HTML <strong> tags

                return (
                    <p key={index} className="my-2" dangerouslySetInnerHTML={{ __html: formattedLine }} />
                );
            }
                    ...
                    >
                        {loading ? (
                            ...
                            <>
                                ...
                                <img src={'/chevron.png'} alt="arrow Icon" className="w-5 h-5 ml-2" />
                            </>
                        )}
                    </button>
                </div>
            ...
            <div className="absolute top-[30%] sm:top-[30%] md:top-[35%] lg:top-[40%] right-10 sm:right-18 md:right-26 lg:right-28 mb-0 z-10">
                ...
                >
                    <img src={'/file-upload.png'} alt="file Icon" className="-ml-2 w-6 h-6" />
                    Upload Reports
                </button>
            </div>
