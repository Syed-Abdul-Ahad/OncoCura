  ...
  const fetchKanbanData = async () => {
    ...
    try {
      const response = await fetch('http://localhost:3000/api/generate-kanban', {
        ...
        body: JSON.stringify({ analysisResult: "Your analysis result here" }),
      });
    ...
    <div className="mt-5 min-h-screen w-72 text-white">
      ...
      >
        <div className="flex absolute mt-20 ml-32">
          <p className="font-poppins font-bold text-3xl text-black relative left-80">View Generated Plan!</p>
        </div>
