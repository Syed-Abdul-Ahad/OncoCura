...
//       className="task relative flex h-[100px] min-h-[100px] font-thin text-black font-poppins cursor-grab items-center rounded-2xl border border-gray-300 shadow-md bg-white p-4 text-left text-sm hover:ring-1 hover:ring-inset hover:ring-[#004DFF]"
...
function TaskCard({ task, deleteTask, updateTask }) {
  ...
  if (editMode) {
    return (
      ...
      >
        <textarea
          className="h-[90%] w-full resize-none rounded border-none bg-transparent text-black focus:outline-none" // Change text color to black
          value={task.content}
          autoFocus
          placeholder="Task content here"
          onBlur={toggleEditMode}
